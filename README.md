...
Then, I made the deployment in Python with the Streamlit library. In the app, you can upload an image of a dog and it will predict its breed and show the image too.
